    ...
    <footer className="bg-deep-brown">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-6">
        ...
        {/* Developer contact — for web app / website build enquiries.
            Stacked on mobile so the three links never wrap mid-row. */}
        <div className="pt-5 mt-5 border-t border-cream/10 flex flex-col items-center gap-3 text-center">
          <p className="text-xs uppercase tracking-[0.18em] font-body font-semibold text-cream/50">
            Web App &amp; Website Enquiries
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-y-2.5 gap-x-8 text-sm font-body text-cream/70">
            <a
            ...
            >
              <svg className="w-4 h-4 text-cream/40 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
