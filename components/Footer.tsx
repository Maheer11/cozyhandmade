...
export default function Footer() {
  return (
    <footer className="bg-deep-brown text-taupe">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-taupe/75 mb-6 max-w-xs font-body">
            ...
            <div className="flex gap-4">
              {["instagram", "pinterest", "facebook"].map((social) => (
                <a
                  ...
                  href="#"
                  aria-label={social}
                  className="w-9 h-9 rounded-full border border-taupe/30 flex items-center justify-center
                             text-taupe hover:text-gold hover:border-gold transition-all duration-200"
                >
                  {social === "instagram" && (
          ...
          {/* Shop */}
          <div>
            <h3 className="font-heading italic text-cream font-400 text-lg mb-5">Shop</h3>
            <ul className="space-y-3">
              {shopLinks.map(({ href, label }) => (
                <li key={label}>
                  <Link
                    href={href}
                    className="text-sm text-taupe/75 hover:text-gold transition-colors duration-200 font-body"
                  >
                    {label}
                  </Link>
                </li>
          ...
          {/* Help */}
          <div>
            <h3 className="font-heading italic text-cream font-400 text-lg mb-5">Help</h3>
            <ul className="space-y-3">
          ...
          {/* About */}
          <div>
            <h3 className="font-heading italic text-cream font-400 text-lg mb-5">About</h3>
            <ul className="space-y-3">
        ...
        {/* Bottom bar */}
        <div className="border-t border-taupe/20 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-taupe/45 font-body">
          ...
          <div className="flex gap-6">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((t) => (
              <a
                key={t}
                href="#"
                className="text-xs text-taupe/45 hover:text-gold transition-colors duration-200 font-body"
              >
                {t}
              </a>
            ))}
