      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-gold text-xs mb-4 font-body tracking-wide">✦ handcrafted with love, since 2018</p>
            <p className="text-cream/60 text-sm leading-relaxed mb-6 max-w-xs font-body">
            ...
            <div className="flex gap-3">
              ...
              <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                 className="w-9 h-9 rounded-full flex items-center justify-center
                            bg-cream/10 text-cream hover:bg-gold hover:text-cream
          ...
          {/* Shop */}
          <div>
            <h3 className="font-heading italic font-400 text-lg text-gold mb-5">Shop</h3>
          ...
          {/* Help */}
          <div>
            <h3 className="font-heading italic font-400 text-lg text-gold mb-5">Help</h3>
            <ul className="space-y-3">
          ...
          {/* About */}
          <div>
            <h3 className="font-heading italic font-400 text-lg text-gold mb-5">About</h3>
            <ul className="space-y-3">
          ...
          <div className="flex gap-6">
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((t) => (
              <a
                key={t}
                href="#"
                className="text-xs font-body text-cream/40 hover:text-cream transition-colors duration-200"
              >
                {t}
              </a>
            ))}
